...
MoveEnd:
	...
	move FIRE_SPIN,    TRAPPING_EFFECT,             35, FIRE,      85, 15 ; todo: thaw frozen pokemon
	...
	move RAGE,         RAGE_EFFECT,                 20, NORMAL,   100, 20 ; check does this move no longer suck?
	move TELEPORT,     SWITCH_AND_TELEPORT_EFFECT,   0, PSYCHIC,  100, 20
	move NIGHT_SHADE,  SPECIAL_DAMAGE_EFFECT,        1, GHOST,    100, 15
	move MIMIC,        MIMIC_EFFECT,                 0, NORMAL,   100, 10 ; copy with 5 pp instead of 9
	...
	move SKULL_BASH,   CHARGE_EFFECT,              130, NORMAL,   100, 10 ; raise user's defense by 1 stage the turn the move is selected
	...
	move SKY_ATTACK,   CHARGE_EFFECT,              200, FLYING,    90,  5 ; todo: 30% chance to flinch
	move TRANSFORM,    TRANSFORM_EFFECT,             0, NORMAL,   100, 10
	move BUBBLE,       SPEED_DOWN_SIDE_EFFECT,      40, WATER,    100, 30
	move DIZZY_PUNCH,  CONFUSION_SIDE_EFFECT,       70, NORMAL,   100, 10 ; should have 20% chance to confuse
