...
.MovesTable
	...
	;db OTHER_M ;PROTECT      EQU $
	db SPECIAL ;SLUDGE_BOMB  EQU $
	db PHYSICAL;OUTRAGE      EQU $
	db PHYSICAL;MEGAHORN     EQU $
	;db OTHER_M ;ENCORE       EQU $
	db PHYSICAL;IRON_TAIL    EQU $
	db PHYSICAL;CRUNCH       EQU $
	db SPECIAL ;MIRROR_COAT  EQU $
	db SPECIAL ;SHADOW_BALL  EQU $
	;db PHYSICAL;FAKE_OUT     EQU $
	db SPECIAL ;HEAT_WAVE    EQU $
	db OTHER_M ;WILL_O_WISP  EQU $
	;db PHYSICAL;FACADE       EQU $
	;db OTHER_M ;TAUNT        EQU $
	;db PHYSICAL;SUPERPOWER   EQU $
	db PHYSICAL;BRICK_BREAK  EQU $
	;db OTHER_M ;YAWN         EQU $
	;db OTHER_M ;BULK_UP      EQU $
	db OTHER_M ;CALM_MIND    EQU $
	db OTHER_M ;ROOST        EQU $
	db PHYSICAL;FEINT        EQU $
	;db PHYSICAL;U_TURN       EQU $
	;db PHYSICAL;SUCKER_PUNCH EQU $
	db PHYSICAL;FLARE_BLITZ  EQU $
	db PHYSICAL;POISON_JAB   EQU $
	db SPECIAL ;DARK_PULSE   EQU $
	db SPECIAL ;AIR_SLASH    EQU $
	db PHYSICAL;X_SCISSOR    EQU $
	db SPECIAL ;BUG_BUZZ     EQU $
	db SPECIAL ;DRAGON_PULSE EQU $
	db OTHER_M ;NASTY_PLOT   EQU $
	db PHYSICAL;ICE_SHARD    EQU $
	db SPECIAL ;FLASH_CANNON EQU $
	db PHYSICAL;POWER_WHIP   EQU $
	;db OTHER_M ;STEALTH_ROCK EQU $
	db PHYSICAL;AQUA_JET     EQU $
	;db OTHER_M ;QUIVER_DANCE EQU $
	;db PHYSICAL;FOUL_PLAY    EQU $
	;db SPECIAL ;CLEAR_SMOG   EQU $
	db SPECIAL ;SCALD        EQU $
	;db OTHER_M ;SHELL_SMASH  EQU $
	;db PHYSICAL;DRAGON_TAIL  EQU $
	db PHYSICAL;DRILL_RUN    EQU $
	db PHYSICAL;PLAY_ROUGH   EQU $
	db SPECIAL ;MOONBLAST    EQU $
	db SPECIAL ;DAZZLE_GLEAM EQU $
	db PHYSICAL;STRUGGLE     EQU $
